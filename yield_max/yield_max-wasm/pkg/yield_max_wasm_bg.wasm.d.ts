...
export const placement_center_col: (a: number) => number;
export const placement_center_label: (a: number) => [number, number];
export const placement_center_row: (a: number) => number;
...
export const placement_label: (a: number) => [number, number];
...
export const row_labels: () => [number, number];
