/* @ts-self-types="./yield_max_wasm.d.ts" */

export class AnalysisResult {
    static __wrap(ptr) {
        const obj = Object.create(AnalysisResult.prototype);
        obj.__wbg_ptr = ptr;
        AnalysisResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        AnalysisResultFinalization.unregister(this);
        return ptr;
    }
    free() {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('yield_max_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
